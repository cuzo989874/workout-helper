...
The following are the critical data types identified from the `src/interface` and `src/types` directories, which define the structure of data within the application, particularly for forms, storage, validation, and workout-related entities.
