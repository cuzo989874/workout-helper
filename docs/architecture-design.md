...
**File**: `app/components/calendar/CalendarHeader.tsx`
...
**File**: `app/components/calendar/CalendarGrid.tsx`
...
**File**: `app/components/calendar/CalendarDateCell.tsx`
...
**File**: `app/components/calendar/CalendarWorkoutModal.tsx`
...
**File**: `app/components/layouts/Header.tsx` (existing, to be modified)
...
**Icon:**
- Use existing `calendar_month.svg` from `app/assets/google-fonts/`
...
**File**: `app/routes/createWorkout.tsx` (existing, minor modification)
...
**New Utils:**
```typescript
// app/utils/calendarUtils.ts (NEW FILE)
...
**Tasks:**
1. Modify `app/components/layouts/Header.tsx`
...
**Tasks:**
1. Modify `app/routes/createWorkout.tsx`
...
|----------|-------|---------|
| **Page** | `app/routes/calendar.tsx` | Main calendar page |
| **Components** | `CalendarHeader.tsx` | Month navigation |
| | `CalendarGrid.tsx` | Calendar grid container |
| | `CalendarDateCell.tsx` | Individual date cell |
| | `CalendarWorkoutModal.tsx` | Workout list modal |
| **Utilities** | `app/utils/calendarUtils.ts` | Date calculations |
| **Modified** | `app/components/layouts/Header.tsx` | Add toggle button |
| | `app/routes/createWorkout.tsx` | Accept date param |
