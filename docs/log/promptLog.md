...
## 2025-10-07 10:25:23
看起來 phase 2 並不是因為兼容性問題如果你是指 svg 的 test 不好寫的話你可以參考 @app/components/feature/ExerciseCard.test.tsx  至於現存的 test wrong ，感覺是應該要分開來看但優先處理，他會是 module css 的問題，是之前遺留的測試
