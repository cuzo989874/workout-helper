...
#### Observations:
- Calendar component directory exists (`src/components/calendar/`) but is empty
...
- src/routes/calendar.tsx + .scss + .test.tsx
- src/components/calendar/CalendarHeader.tsx + .scss + .test.tsx
- src/components/calendar/CalendarGrid.tsx + .scss + .test.tsx
- src/components/calendar/CalendarDateCell.tsx + .scss + .test.tsx
- src/components/calendar/CalendarWorkoutModal.tsx + .scss + .test.tsx
- src/utils/calendarUtils.ts + .test.ts

### Files to Modify (5 files):
- src/routes.ts (add calendar route)
- src/components/layouts/Header.tsx + .scss + .test.tsx
- src/routes/createWorkout.tsx (handle date query param)
...
- ✅ Files created:
  - src/utils/calendarUtils.ts (120 lines)
  - src/utils/calendarUtils.test.ts (160 lines)
- ✅ Route added to src/routes.ts
...
**New Files (13)**:
1. src/utils/calendarUtils.ts
2. src/utils/calendarUtils.test.ts
3. src/components/calendar/CalendarDateCell.tsx
4. src/components/calendar/CalendarDateCell.module.scss
5. src/components/calendar/CalendarDateCell.test.tsx
6. src/components/calendar/CalendarGrid.tsx
7. src/components/calendar/CalendarGrid.module.scss
8. src/components/calendar/CalendarHeader.tsx
9. src/components/calendar/CalendarHeader.module.scss
10. src/components/calendar/CalendarWorkoutModal.tsx
11. src/components/calendar/CalendarWorkoutModal.module.scss
12. src/routes/calendar.tsx
13. src/routes/calendar.module.scss

**Modified Files (3)**:
1. src/routes.ts (added calendar route)
2. src/components/layouts/Header.tsx (added toggle button)
3. src/components/layouts/Header.module.scss (button styles)
4. src/routes/createWorkout.tsx (date query param)
